...
namespace PlatformUnoTest.DAL.Migrations
{
    ...
    [Migration("20221004113415_AddDistributionsAndPlaneTypeModuleDistributions")]
    partial class AddDistributionsAndPlaneTypeModuleDistributions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlatformUnoTest.DAL.Distribution", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlatformUnoTest.DAL.PlaneTypeModuleDistribution", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("PlaneTypeModuleId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PlaneTypeModuleId");

                    b.HasIndex("DistributionId", "PlaneTypeModuleId")
                        .IsUnique();

                    b.ToTable("PlaneTypeModuleDistributions");
                });
            ...
            modelBuilder.Entity("PlaneTypeTask", b =>
                {
                    b.Property<long>("PlaneTypesId")
                        .HasColumnType("INTEGER");

                    b.Property<long>("TasksId")
                        .HasColumnType("INTEGER");

                    b.HasKey("PlaneTypesId", "TasksId");

                    b.HasIndex("TasksId");

                    b.ToTable("PlaneTypeTask");
                });
            ...
            modelBuilder.Entity("PlatformUnoTest.DAL.Distribution", b =>
                {
                    b.HasOne("PlatformUnoTest.DAL.Employee", "Manager")
                        .WithMany("ManagedDistributions")
            ...
            modelBuilder.Entity("PlatformUnoTest.DAL.PlaneTypeModuleDistribution", b =>
                {
                    b.HasOne("PlatformUnoTest.DAL.Distribution", "Distribution")
                        .WithMany("PlaneTypeModuleDistributions")
                        .HasForeignKey("DistributionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlatformUnoTest.DAL.PlaneTypeModule", "PlaneTypeModule")
                        .WithMany("PlaneTypeModuleDistributions")
                        .HasForeignKey("PlaneTypeModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Distribution");

                    b.Navigation("PlaneTypeModule");
                });
            ...
            modelBuilder.Entity("PlaneTypeTask", b =>
                {
                    b.HasOne("PlatformUnoTest.DAL.PlaneType", null)
                        .WithMany()
                        .HasForeignKey("PlaneTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlatformUnoTest.DAL.Task", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlatformUnoTest.DAL.Distribution", b =>
                {
                    b.Navigation("PlaneTypeModuleDistributions");
                });
            ...
            modelBuilder.Entity("PlatformUnoTest.DAL.Employee", b =>
                {
                    ...
                    b.Navigation("ManagedDistributions");
